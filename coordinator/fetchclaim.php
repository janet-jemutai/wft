...
foreach($result as $row)
{
 ...
 $sub_array[] = '<button type="button" name="update" id="'.$row["code"].'" class="btn btn-warning btn-xs update">Update</button>';
 $sub_array[] = '<button type="button" name="delete" id="'.$row["code"].'" class="btn btn-danger btn-xs delete">Delete</button>';
 $data[] = $sub_array;
}
$output = array(
