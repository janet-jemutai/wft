 ...
 <body>
  <div class="container box">
   <div class="row">
    ...
    <div class="col-md-8">
   <h1 align="center">MANAGE COORDINATORS</h1>
   
   
 </div>
 <div class="col-md-2">
   <button type="submit" style="color: black;" class="btn btn-success">
     <a href="addcoordinator.php">Add New Coordinator</a>
   </button>
 </div>
  </div>
...
$(document).ready(function(){
 ...
 var name = $('#name').val();
  ...
  var phone = $('#phone').val();
  if(name!= '' && school !='' && email!='' && password !='' && phone!=''){
  $.ajax({
    url:"update.php",
    method:'POST',
 ...
 $(document).on('click', '.update', function(){
  ...
  $.ajax({
   url:"fetch_singlecoordinator.php",
   method:"POST",
   ...
   success:function(data)
   {
    ...
    $('.modal-title').text("Edit coordinator");
    $('#work_id').val(work_id);
    $('#action').val("Edit");
    $('#operation').val("Edit");
   }
