...
<?php
  ...
  $sql="INSERT INTO admin(name,password, work_id, email, role, phone_numer, branch)
  VALUES('$name', '$password','$work_id', '$email', 'admin', '$phone', '$branch')";
  if(mysqli_query($conn, $sql)){
    $sql1="INSERT INTO login(id,username,password,role) VALUES(
    '$work_id','$name','$password','admin')";
    if(mysqli_query($conn, $sql1)){
    $Succmsg="Admin added successfully";
